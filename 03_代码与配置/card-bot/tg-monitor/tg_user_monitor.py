    ...
    async def start_monitor(self) -> None:
        async with self.lock:
            ...
            async def handle_source_event(event, event_name: str):
                ...
                if not links:
                    log.info(
                        "收到来源消息但未提取到115链接: event=%s msg_id=%s text=%r entities=%s",
